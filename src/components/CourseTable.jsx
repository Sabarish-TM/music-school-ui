...
const CourseTable = () => {
  ...
  const columns =  [
     ...
     <Chip variant="outlined" color="secondary" size="small" label={row?.original?.status}/>
      </Stack>
       )}
...
>
 ...
 <Stack sx={{mr:'10%'}}>
  <MaterialReactTable table={table} width={'95%'}  marginRight={'10%'}/>
  </Stack>
       <Dialog
        open={open}
        onClose={handleClose}
      ...
      <FormControl sx={{  width: '100%',mt:1 }}>
        <InputLabel id="demo-multiple-checkbox-label">Date of the week</InputLabel>
        <Select
          labelId="demo-multiple-checkbox-label"
          id="demo-multiple-checkbox"
          value={day}
       ...
       <TextField
        ...
        <DialogActions>
          ...
          <Button variant='outlined' onClick={handleAddColumn} >Add Course</Button>
        </DialogActions>
      </Dialog>
